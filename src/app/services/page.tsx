...
const ServicesPage = () => {
  ...
  className="px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_auto] text-white rounded-xl font-bold text-lg shadow-lg flex items-center mx-auto"
>
...
<AnimatePresence>
  {hoveredService === index && (
    ...
    >
      <div className="p-6 text-zinc-900 bg-white">
  ...
  className="px-8 py-4 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_auto] text-white rounded-xl font-bold text-lg shadow-lg flex items-center justify-center"
>
...
//                   >
//                     <div className="p-6 text-zinc-900 bg-slate-50">
//                       <h3 className="font-bold mb-2">Ideal For:</h3>
//                       <p className="text-sm">
//                         {service.title === "Revenue Cycle Management" && "Hospitals, clinics, and large practices seeking full-cycle revenue optimization"}
//                         {service.title === "Medical Billing & Claims" && "Small practices, solo providers, and specialty clinics"}
